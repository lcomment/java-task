...
<body>
	<div class="container">
		<form class="form-horizontal" action="/app/modify" method="post">
			...
			<div class="form-group">
				<label for="no" class="col-sm-2 control-label">글번호</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="author" value="${board.getAuthor()}">
				</div>
			</div>
			<div class="form-group">
